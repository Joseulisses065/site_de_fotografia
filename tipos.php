...
<body>
    ...
    <main>
        ...
        <!--seção familia do site-->
        <section class="familia" id="familia">
            <div class="texto-centro">
                <h2>Para aproveitar em familia</h2>
                <h1>Familia</h1>
            </div>
        ...
        <!--seção esportes do site-->
        <section class="esportes" id="esportes">
            <div class="texto-centro">
                <h2>Melhores lugares para esportes</h2>
                <h1>Esportes</h1>
            </div>
            <div class="esportes-imagem">
        ...
        <section class="cultura" id="cultura">
            <div class="texto-centro">
                <h2>Conheça a cultura de diferentes lugares</h2>
                <h1>Cultura</h1>
            </div>
        ...
        <section class="comida" id="comida">
            <div class="texto-centro">
                <h2>Aproveite a melhor culinaria</h2>
                <h1>Comida</h1>
            </div>
            <div class="comida-imagem">
        ...
        <section class="contato" id="contato">
            ...
            <div class="navegacao">
                ...
                <ul>
                    ...
                    <li class="cont-li"><a href="#esportes">Esportes</a></li>
                    <li class="cont-li"><a href="#cultura">Cultura</a></li>
                    <li class="cont-li"><a href="#comida">Comida</a></li>
