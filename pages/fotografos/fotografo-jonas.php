    ...
    <main>
        ...
        <section class="inicio" id="inicio">
            <div class="inicio-imagem">
                <img src="../../img/fotografos-3.jpg" alt="">

            </div>

            <div class="inicio-texto">
                <h1>Jonas Silva</h1>
                <h2>Fotografo e redator</h2>
        ...
        <section class="contato" id="contato">
            ...
            <div classe="contatenos">
                ...
                <ul>
                    ...
                    <li class="redes-sociais"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-twitter"
                        viewBox="0 0 16 16">
                        <path
            ...
            <div class="navegacao">
                ...
                <ul>
                    ...
                    <li class="cont-li"><a href="#trabalhos">trabalhos</a></li>
